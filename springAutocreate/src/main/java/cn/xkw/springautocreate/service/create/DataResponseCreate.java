...
@Service
@ListManage
public class DataResponseCreate implements BaseSrBankCreate {
    ...
    public Boolean create(Model model) {
        try {
            ...
            Template template = cfg.getTemplate(CommonData.TEMPLATE_FILE_DATA_RESPONSE_NAME);
            ...
            File moduleFile = new File(CommonData.SRBANK_WRITE_FILE_PATH + model.getClassName() + "/" + model.getClassName() + "Response.java");
